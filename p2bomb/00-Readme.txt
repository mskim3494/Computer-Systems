...
If two students (e.g. with CNetIDs "foo" and "bar") have formed a
work-group pair at https://work-groups.cs.uchicago.edu/login then the
graders will be looking for a bomb generated for "foo+bar" or
"bar+foo", and saved in this directory in the pair repository. The
contents of this directory in the individual repositories
(foo-cs154-2015 and bar-cs154-2015) will then be ignored.
